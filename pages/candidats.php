...
require "../fonctions/candidats.php";
...
<head>
    ...
    <title>Liste des candidats | UFHB </title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <h1 class="h4 mb-1 text-primary text-uppercase mb-4">Liste des candidats</h1>
                ...
                <div class="card shadow mb-5">
                    <div class="card-header">
                        <h6 class="m-0 font-weight-bold text-primary text-uppercase">Liste des étudiants</h6>
                    </div>
                    <div class="card-body">
